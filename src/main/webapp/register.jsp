...
<html>
	...
	<div class="login-box">
	  ...
	  <form id="myForm" action="register-2.jsp" method="post">
	  	<div id="meta1">
		    ...
		    <div class="user-box">
		      <input id="confermaPassword" type="password" name="confermaPassword">
	    ...
	    <div id="meta2" style="display: none;">
		    ...
		    <div class="user-box">
		     ...
		     <div class="user-box">  
		      <br> 
		      <input id="nascita" type="date" name="nascita">
	    ...
	    <button id="submitButton" type="button" class="login-button" style="display: none;">
	      <span></span>
	      <span></span>
	      <span></span>
	      <span></span>
	...
	<script>
	document.getElementById('controllaPrima').addEventListener('click', controllaPrima);
	document.getElementById('submitButton').addEventListener('click', controllaSeconda); 
		...
		document.addEventListener('keydown', function(event) {
			...
			if (event.keyCode === 13) {
				...
				if (currentIndex === mioArray.length - 4) {
			...
			if (event.key === "ArrowUp" || event.key === "ArrowDown") {
			    ...
			    nextIndex = Math.max(0, Math.min(nextIndex, mioArray.length - 1));
		...
		function controllaPrima(event) {
			...
			var email = document.getElementById('email').value;
			  ...
			  if ((username === '' || email === '' || password === '' || confermaPassword === '') && (password !== confermaPassword)) {
			  ...
			  } else if (username === '' || email === '' || password === '' || confermaPassword === ''){
