		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-sm-12">
					...
					<div class="card" style="margin-top: 20px; border: 5px solid white; border-radius: 5px;">
  						<div class="card-header">
    					I tuoi traguardi!
  						</div>
  						<div class="card-body" style="border: 3px solid black; border-radius: 10px;">
    							...
    							<div class="row">
    								<div class="col-6">
    									...
    									<div id="aggInd">
                                            		<button class="btn btn-secondary" type="button" id="showForm">Aggiungi</button>
														...
														<div class="d-flex justify-content-between">
															<button class="btn btn-secondary mt-2" type="button" id="annulla" >Annulla</button>
															<button class="btn btn-secondary mt-2" id="submit" type="button">Aggiungi</button>	
                                            			</div>
                                            			</div>
                                            		</div>
    									<% } %>
    								...
    								<div class="col-6">
                                        ...
                                        <p id="email"><%=utente.getEmail() %></p>
    										<div id="modificaEmail" class="col-md-6" style="display: none; width: auto; margin-top: 15px;">
                                            	<input name="newEmail" value="<%=utente.getEmail()%>" placeholder="Email">
                                        	</div>
    									<p id="numeroTelefono"><%=utente.getNumeroTelefono() %></p>
    										<div id="modificaNumeroTelefono" class="col-md-6" style="display: none; width: auto; margin-top: 15px;">
                                          		<input name="newNumeroTelefono" value="<%=utente.getNumeroTelefono()%>" placeholder="Telefono">
                                            </div>
    									<% if (utente.getIndirizzo() != null) { %>
    									...
    									<div id="modificaIndirizzo" style="display: none;">
                                        	<input name="newPaese" value="<%=utente.getIndirizzo().getPaese()%>" placeholder="Paese">
                                        	<input style="margin-top: 15px;" name="newCitta" value="<%=utente.getIndirizzo().getCitta()%>" placeholder="Città">
                                        	<input style="margin-top: 15px;" name="newVia" value="<%=utente.getIndirizzo().getVia()%>" placeholder="Via">
                                        	<input style="margin-top: 15px;" name="newNumeroCivico" value="<%=utente.getIndirizzo().getNumeroCivico()%>" placeholder="Numero civico">
                                       	</div>
    								<% } %>	
    								</div>
    							</div>
