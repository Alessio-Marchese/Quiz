		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-sm-12">
					<h1
						style="justify-content: center; margin-top: 52px; margin-bottom: 50px;">
						Ciao
						<%=utente.getNome()%>!
					</h1>
					<div class="card"
						style="border: 4px solid white; border-radius: 5px; border-color: #e91e63; background-color:  #24262b; color: white;">
						<div class="card-header">Riprendi da dove hai lasciato!</div>
						<div class="card-body"
							style="border: 3px solid black; border-radius: 10px;">
							<p class="card-text text-wrap">Questo è il tuo hub personale,
								da qui puoi recuperare gli ultimi argomenti studiati o
								riprendere gli esercizi dall'ultimo quiz svolto</p>
							<div class="d-flex justify-content-between">
								<a href="#" class="btn btn-danger">Teoria (Nome Teoria)</a> <a
									href="#" class="btn btn-danger">Quiz (Nome Quiz)</a>
							</div>
						</div>
					</div>
					<div class="card"
						style="margin-top: 20px; border: 4px solid white; border-radius: 5px; border-color: #e91e63; background-color:  #24262b; color: white;">
						<div class="card-header">I tuoi traguardi!</div>
						<div class="card-body"
							style="border: 3px solid black; border-radius: 10px;">
							<div class="d-flex justify-content-between">
								<%
								...
								%>
								<p>
									Quiz completati 0/<%=numeroQuiz%></p>
								<p>
									Badge ottenuti
									<%=badgeOttenuti%>/<%=badgeTotali%></p>
							</div>
						</div>
					</div>
				</div>
